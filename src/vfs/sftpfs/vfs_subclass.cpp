                           ...
                           const vfs_path_t * vpath, const vfs_path_element_t * vpath_element)
{
    ...
    if (vpath_element->host == NULL || *vpath_element->host == '\0')
    {
        ...
        vpath_element->vclass->verrno = EPERM;
        return -1;
    }
    ...
    {
        vpath_element->vclass->verrno = ret_value;
        return -1;
    }

    super->name = g_strdup (PATH_SEP_STR);
    super->root =
        vfs_s_new_inode (vpath_element->vclass, super,
                         vfs_s_default_stat (vpath_element->vclass, S_IFDIR | 0755));

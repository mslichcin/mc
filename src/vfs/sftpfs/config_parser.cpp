...
sftpfs_fill_connection_data_from_config (struct vfs_s_super *super, GError ** mcerror)
{
    ...
    super_data->config_auth_type = (sftpfs_auth_type_t)(super_data->config_auth_type |(config_entity->pubkey_auth) ? PUBKEY : 0);
    super_data->config_auth_type = (sftpfs_auth_type_t)(super_data->config_auth_type |(config_entity->identities_only) ? 0 : AGENT);
    super_data->config_auth_type = (sftpfs_auth_type_t)(super_data->config_auth_type |(config_entity->password_auth) ? PASSWORD : 0);

                              ...
                              long *col1, long *col2)
{
    ...
    data = (unsigned char *)g_malloc0 (TEMP_BUF_LEN);
...
edit_insert_file (WEdit * edit, const vfs_path_t * filename_vpath)
{
    ...
    else
    {
        ...
        buf = (char *)g_malloc0 (TEMP_BUF_LEN);
           ...
           long line)
{
    ...
    {
        Widget *w;
        edit = (WEdit *)g_malloc0 (sizeof (WEdit));
        to_free = TRUE;

        w = WIDGET (edit);
        widget_init (w, y, x, lines, cols, NULL, NULL);
        w->options = (widget_options_t)(w->options | WOP_SELECTABLE | WOP_TOP_SELECT | WOP_WANT_CURSOR);
    ...
    edit->undo_stack = (long *)g_malloc0 ((edit->undo_stack_size + 10) * sizeof (long));

    edit->redo_stack_size = START_STACK_SIZE;
    edit->redo_stack_size_mask = START_STACK_SIZE - 1;
    edit->redo_stack = (long *)g_malloc0 ((edit->redo_stack_size + 10) * sizeof (long));
...
edit_reload_line (WEdit * edit, const vfs_path_t * filename_vpath, long line)
{
    ...
    e = (WEdit*)g_malloc0 (sizeof (WEdit));
    *WIDGET (e) = *w;
    /* save some widget parameters */
...
edit_push_undo_action (WEdit * edit, long c)
{
    ...
    {                           /* say */
        ...
        {
            t = (long*)g_realloc (edit->undo_stack, (edit->undo_stack_size * 2 + 10) * sizeof (long));
            if (t)
            {
                edit->undo_stack = t;
...
edit_push_redo_action (WEdit * edit, long c)
{
    ...
    {                           /* say */
        ...
        {
            t = (long*)g_realloc (edit->redo_stack, (edit->redo_stack_size * 2 + 10) * sizeof (long));
            if (t)
            {
                edit->redo_stack = t;

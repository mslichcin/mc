...
edit_about (void)
{
    ...
    quick_widgets[0].pos_flags = (widget_pos_flags_t)(WPOS_KEEP_TOP | WPOS_CENTER_HORZ);
    quick_widgets[2].pos_flags = (widget_pos_flags_t)(WPOS_KEEP_TOP | WPOS_CENTER_HORZ);
    quick_widgets[4].pos_flags = (widget_pos_flags_t)(WPOS_KEEP_TOP | WPOS_CENTER_HORZ);
...
edit_window_list (const WDialog * h)
{
    ...
    selected = (WEdit *)run_listbox_with_data (listbox, h->current->data);
    if (selected != NULL)

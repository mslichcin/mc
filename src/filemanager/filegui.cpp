...
#define ADD_RD_LABEL(i, p1, p2, ypos) \
    ...
    /* *INDENT-OFF* */
        /*  0 */
        { N_("Target file already exists!"), 3, 4, (widget_pos_flags_t)(WPOS_KEEP_TOP | WPOS_CENTER_HORZ), 0 },
        /*  1 */
        { "%s", 4, 4, (widget_pos_flags_t)(WPOS_KEEP_TOP | WPOS_CENTER_HORZ), 0 },
        /*  2 */
        ...
        /* 14 */
        { N_("&Abort"), 14, 25, (widget_pos_flags_t)(WPOS_KEEP_TOP | WPOS_CENTER_HORZ), REPLACE_ABORT }
    /* *INDENT-ON* */
    };
    ...
    stripped_name = stripped_name_orig =
        vfs_path_to_str_flags (stripped_vpath, 0, (vfs_path_flag_t)(VPF_STRIP_HOME | VPF_STRIP_PASSWORD));
...
check_progress_buttons (file_op_context_t * ctx)
{
    ...
    ui = (file_op_context_ui_t*)ctx->ui;
                           ...
                           filegui_dialog_type_t dialog_type)
{
    ...
    if (dialog_type != FILEGUI_DIALOG_DELETE_ITEM)
    {
        ...
        add_widget_autopos (ui->op_dlg, ui->progress_file_gauge, (widget_pos_flags_t)(WPOS_KEEP_TOP | WPOS_KEEP_HORZ),
                            NULL);
        ...
        if (verbose && dialog_type == FILEGUI_DIALOG_MULTI_ITEM)
        {
            ...
            if (ctx->progress_totals_computed)
            {
                ...
                add_widget_autopos (ui->op_dlg, ui->progress_total_gauge,
                                    (widget_pos_flags_t)(WPOS_KEEP_TOP | WPOS_KEEP_HORZ), NULL);
            }
    ...
    if (progress_buttons[2].len == -1)
    {
        ...
        send_message (progress_buttons[2].w, NULL, widget_msg_t::DESTROY, 0, NULL);
                  ...
                  const char *format, const void *text, const char *def_text, gboolean * do_bg)
{
    ...
    *do_bg = FALSE;
    ...
    if (only_one)
    {
        ...
        text_len = str_term_width1 ((const char*)text);
        max_len = COLS - 2 - 6;

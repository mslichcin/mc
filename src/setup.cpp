...
panels_options_t panels_options = {
    ...
    .select_flags = (panel_select_flags_t)(SELECT_MATCH_CASE | SELECT_SHELL_PATTERNS)
};
...
panels_load_options (void)
{
    if (mc_config_has_group (mc_global.main_config, CONFIG_PANELS_SECTION))
    {
        ...
        panels_options.select_flags =
            (panel_select_flags_t) mc_config_get_int (mc_global.main_config, CONFIG_PANELS_SECTION, "select_flags",

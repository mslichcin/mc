...
mousedispatch_new (int y, int x, int yl, int xl)
{
    ...
    w->options = (widget_options_t)(w->options | WOP_SELECTABLE | WOP_WANT_CURSOR);
                          ...
                          gpointer init_data, gpointer data)
{
    ...
    whelp =
        dlg_create (TRUE, 0, 0, help_lines + 4, HELP_WINDOW_WIDTH + 4, (widget_pos_flags_t)(WPOS_CENTER | WPOS_TRYUP),
